...
void solve()
{
    ...
    while (n--)
    {
        ...
        else
        {
            if (left.count(val))
            {
                int delta1 = left.size() - data[val];
                int delta2 = (data[val] - 1) + (right.size());

                std::cout << std::min(delta1, delta2) << '\n';
            }
            else
            {
                int delta1 = right.size() - data[val];
                int delta2 = (data[val] - 1) + (left.size());
