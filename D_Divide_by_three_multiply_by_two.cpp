...
void solve()
{
    ...
    while (data.size() > 0)
    {
        ...
        else if (data.count(left2))
        {
            inox.push_front(left2);
            data[left2]--;
        ...
        if (data.count(right1))
        {
            inox.push_back(right1);
            data[right1]--;
        ...
        else if (data.count(right2))
        {
            inox.push_back(right2);
            data[right2]--;
