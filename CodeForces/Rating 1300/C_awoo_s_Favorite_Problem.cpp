...
void solve()
{
    ...
    for (int i = 0; i < n; i++)
    {
        ...
        {
            if ((text2[i] == 'a' && text1[index] == 'c') || (text2[i] == 'c' && text1[index] == 'a') || (text2[i] == 'b' && text1[index] == 'c') || (text2[i] == 'a' && text1[index] == 'b'))
            {
                std::cout << "NO\n";
                rn;
            }
