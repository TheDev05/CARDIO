...
void solve()
{
    ...
    int finalHour = imax, finalMin = imax;
    ...
    for (int i = 0; i < n; i++)
    {
        ...
        if (h < hour)
        {
            ...
            result_min = m + delta_Min;
            result_hour = h + delta_Hour;
            ...
            if (result_hour < finalHour)
            {
                finalHour = result_hour;
                finalMin = result_min;
            }
        }
        else if (h > hour)
        {
            if (m < min)
            {
                int result_hour = (h - hour) - 1;
                int result_min = 60 - (min - m);
            ...
            {
                int result_hour = (h - hour);
                int result_min = (m - min);
