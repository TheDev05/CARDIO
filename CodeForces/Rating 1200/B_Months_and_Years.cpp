...
void solve()
{
    ...
    vi num(n), res;
    vi data{31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31};
    ...
    // After 4 years, leap comes, 29 then 28 not 29!
    // Due: Intersection years
    ...
    {
        if ((num[0] == 28 && data[i] == 29) || (num[0] == 29 && data[i] == 28) || data[i] == num[0])
        {
            int index = i, count1 = 0, count2 = 0;
            bool ok = true;

            for (int j = 0; j < n; j++)
            {
                if ((num[j] == 28 && data[index] == 29) || (num[j] == 29 && data[index] == 28) || data[index] == num[j])
                {
                    if (num[j] == 28)
                    {
                        count1++;
