...
void solve()
{
    ...
    while (t--)
    {
        ...
        if ((i + j) & 1)
        {
            ll val1 = ceil((double)n / 2);
            ll val2 = (n / 2);

            ll inox = i - 1;

            ll temp1 = ceil((double)inox / 2) * val2;
            ll temp2 = (inox / 2) * val1;

            // db(temp1);
            // db(temp2);

            ll total = (ceil((double)n / 2) * val1) + ((n / 2) * val2);
        ...
        else
        {
            ...
            ll temp1 = ceil((double)inox / 2) * val1;
            ll temp2 = (inox / 2) * val2;
