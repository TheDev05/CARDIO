...
void solve()
{
    ...
    map<int, pair<char, int>> data1;
    map<int, pair<char, int>> data2;

    for (int i = 0; i < text1.size(); i++)
    {
        int index = i, count = 0;
        while (text1[i] == text1[index])
        {
            index++;
            count++;
        }

        data1[i].first = text1[i];
        data1[i].second = count;
    ...
    {
        int index = i, count = 0;
        while (text2[i] == text2[index])
        {
            index++;
            count++;
        }

        data2[i].first = text2[i];
        data2[i].second = count;
    ...
    for (int i = 0; i < data1.size(); i++)
    {
        ...
        if (it2->second.second < it1->second.second)
        {
            std::cout << "NO\n";
            rn;
        }
