...
void solve()
{
    ...
    while (t--)
    {
        ...
        for (int i = 0; temp.size() == text.size() && i < temp.size(); i++)
        {
            ...
            if (data1.find(text[i]) != string::npos && data1.find(temp[i]) != string::npos)
            {
                count++;
            }
            else if (data2.find(text[i]) != string::npos && data2.find(temp[i]) != string::npos)
            {
                count++;
            }
            else if (text[i] == temp[i])
            {
                count++;
            }
        }
