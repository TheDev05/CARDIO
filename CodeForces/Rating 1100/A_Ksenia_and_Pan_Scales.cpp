...
void solve()
{
    ...
    std::string text, advance;
    std::cin >> text >> advance;

    int pluto = advance.size();
    ...
    else
    {
        ...
        for (int i = 0; i < delta; i++)
        {
            text.insert(text.size(), 1, advance[0]);
            advance.erase(0, 1);
        }
    }
