...
void solve()
{
    ...
    map<ll, pair<ll, pair<ll, ll>>> num;

    num[1].first = 0;
    num[1].second.first = x + 1;
    num[1].second.second = y;

    num[2].first = 0;
    num[2].second.first = x - 1;
    num[2].second.second = y;

    num[3].first = 0;
    num[3].second.first = x;
    num[3].second.second = y + 1;

    num[4].first = 0;
    num[4].second.first = x;
    num[4].second.second = y - 1;
    ...
    ll max = imin, cod1, cod2;
    for (auto i : num)
    {
        if (i.second.first > max)
        {
            max = i.second.first;
            cod1 = i.second.second.first;
            cod2 = i.second.second.second;
        }
    }
